...
# %%
print("Loading fine-tuned R(2+1)D model...")
device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

# Complexity raporu gerçekte kullandığımız (fine-tune edilmiş) modeli yansıtmalı,
# ham Kinetics-400 ağırlıklarını değil
...
# %%
print("=" * 45)
print("R(2+1)D Complexity Report")
print("=" * 45)
print(f"Total Parameters:      {total_params:,}")
